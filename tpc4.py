...
def leLista(N):
    ...
    while k < N:
        k = k + 1
        MainList.append(int(input("introduza um número para a sua lista1-"))) 
    return MainList
...
while modo != 0:
    modo = int(input(cor_amarela+"""Crie uma aplicação em Python que coloca no monitor o seguinte menu:\n(1) Criar Lista\n(2) Ler Lista\n(3) Soma\n(4) Média\n(5) Maior\n(6) Menor\n(7) estaOrdenada por ordem crescente\n(8) estaOrdenada por ordem decrescente\n(9) Procura um elemento\n(0) Sair\nQue operação quer realizar?-"""+cor_reset))
    ...
    if modo == 1:
        ...
        print(MainList)
        print(indiceDe(MainList,int(input("Procura um número na lista-"))))

    if modo == 0:
        print(cor_vermelha+"Saíste do jogo!"+cor_reset)
